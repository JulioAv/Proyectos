...
void main(void) {
    ...
    while(1){
        ...
        slave1 = I2C_Master_Read(0);
        I2C_Master_Stop();
        _delay((unsigned long)((200)*(8000000/4000.0)));

        I2C_Master_Start();
        I2C_Master_Write(0x31);
        slave2 = I2C_Master_Read(0);
        I2C_Master_Stop();
        _delay((unsigned long)((200)*(8000000/4000.0)));
# 135 "master_main.c"
        if(val == 0){
        ...
        if (PIR1bits.TXIF){
                    ...
                    TXREG = sensor1_centenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor1_decenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor1_unidades;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = 0x2C;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor2_centenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor2_decenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor2_unidades;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = 0x2C;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor3_centenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor3_decenas;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = sensor3_unidades;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
                    TXREG = 0x0D;
                    _delay((unsigned long)((20)*(8000000/4000.0)));
            }
